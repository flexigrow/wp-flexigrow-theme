  ...
  <div class="relative bg-blackOverlay py-12 md:py-32">
    <div class="md:container mx-auto !px-5 md:!px-0 text-white">
      <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-8 md:mb-20">
        <h2 class="wow animate__animated animate__fadeIn text-3xl md:text-[42px] md:leading-[46px] font-semibold">
          <?php echo $sw_title; ?>
        </h2>
      ...
      <div class="grid grid-cols-12 gap-4 md:gap-20 mb-20 md:mb-0">
        <div class="col-span-12 xl:col-span-4 lg:col-span-6">
          <div class="border border-solid border-white space-y-5 !p-5 md:!px-8 md:!py-14 rounded-3xl">
            <h3 class="wow animate__animated animate__fadeIn prose text-2xl leading-[36px] font-bold text-white"><?php echo $sw_body_card['heading'] ?? ''; ?></h3>
            <div class="wow animate__animated animate__fadeIn prose text-white"><?php echo $sw_body_card['content'] ?? ''; ?></div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-12 gap-6">
            <?php if (!empty($sw_list)) : ?>
              <?php foreach ($sw_list as $key => $tab) : ?>
                <div data-wow-delay="<?php echo $key * 100; ?>ms" class="wow animate__animated animate__fadeIn col-span-12 md:col-span-4">
